...
export function HeroSection() {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-20">
      ...
      <div className="absolute top-10 left-10 h-72 w-72 rounded-full bg-warm/20 blur-3xl" />
      <div className="absolute bottom-20 right-10 h-64 w-64 rounded-full bg-peach/20 blur-3xl" />
      <div className="absolute top-1/2 left-1/3 h-48 w-48 rounded-full bg-cream/40 blur-3xl" />

      <div className="relative z-10 mx-auto flex max-w-6xl flex-col items-center gap-8 lg:flex-row lg:gap-16">
        {/* Text content - LEFT side */}
        <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
          <p className="mb-3 inline-block rounded-full bg-warm/20 px-4 py-1.5 text-sm font-medium text-warm-foreground">
        ...
        <div className="flex-shrink-0 order-1 lg:order-2">
          <div className="relative">
            <div className="absolute inset-0 rounded-full bg-gradient-to-br from-warm/30 to-peach/30 blur-2xl scale-110" />
            <img
              src={heroImg}
