...
const projects = [
  ...
  },
  {
    ...
    description: "A modern CRM application for managing customer interactions, leads, and business relationships.",
    tags: ["React", "TypeScript", "TailwindCSS"],
    color: "bg-lavender/40",
    live: "https://future-fs-02-wine-chi.vercel.app",
    github: "https://github.com/pranathiii2007-ops",
  },
  {
    title: "E-Commerce Store",
    subtitle: "Online Shopping Platform",
    description: "A full-featured e-commerce application with product browsing, cart management, and checkout flow.",
    tags: ["React", "TypeScript", "TailwindCSS"],
    color: "bg-peach/40",
    live: "https://future-fs-03-t77b.vercel.app",
    github: "https://github.com/pranathiii2007-ops",
  },
  {
    title: "Portfolio",
